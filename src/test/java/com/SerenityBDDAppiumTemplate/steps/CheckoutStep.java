...
public class CheckoutStep extends ScenarioSteps {
    ...
    @Step("retorna texto full name invalid label")
    public String retornaTextoFullNameInvalidLabel(){
        return checkoutPage.retornaTextoFullNameInvalidLabel();
    }

    @Step("retorna texto card number invalid label")
    public String retornaTextoCardNumberInvalidLabel(){
        return checkoutPage.retornaTextoCardNumberInvalidLabel();
    }

    @Step("retorna texto expiration date invalid label")
    public String retornaTextoExpirationDateInvalidLabel(){
        return checkoutPage.retornaTextoExpirationDateInvalidLabel();
    }

    @Step("retorna texto security code invalid label")
    public String retornaTextoSecurityCodeInputInvalidLabel(){
        return checkoutPage.retornaTextoSecurityCodeInputInvalidLabel();
    }
