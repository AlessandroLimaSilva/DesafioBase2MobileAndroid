...
public class CompraStepDefinition {
    ...
    public void oItemFoiRemovidoComSucesso(){
        Assert.assertTrue(myCartStep.retornaTextoSeCarrinhoVazioLabel().equalsIgnoreCase("No Items"));
    }
    ...
    public void emPagamentoTenhaInformadoNomeDoTitularDoCartaoNumeroDoCartaoDataDeValidadeECodigoDeSeguranca(String nomeCompletoCard,String numeroDoCartao,String dataDeValidade,String codigoDeSeguranca){
    ...
    public void oUsuarioConfirmarACompra(){
        ...
        checkoutStep.clicarPlaceOrderButton();
    ...
    public void eInformadoQueONomeCompletoDoCartaoNaoFoiInformado(){
        Assert.assertTrue(checkoutStep.retornaTextoFullNameInvalidLabel().equalsIgnoreCase("Value looks invalid."));
    }

    @Then("é informado que o numero do cartão não foi informado")
    public void eInformadoQueONumeroDoCartaoNaoFoiInformado(){
        Assert.assertTrue(checkoutStep.retornaTextoCardNumberInvalidLabel().equalsIgnoreCase("Value looks invalid."));
    }
    ...
    public void eInformadoQueADataDeValidadeDoCartaoNaoFoiInformado(){
        Assert.assertTrue(checkoutStep.retornaTextoExpirationDateInvalidLabel().equalsIgnoreCase("Value looks invalid."));
    }

    @Then("é informado que o codigo de segurança do cartão não foi informado")
    public void eInformadoQueOCodigoDeSegurançaDoCartaoNaoFoiInformado(){
        Assert.assertTrue(checkoutStep.retornaTextoSecurityCodeInputInvalidLabel().equalsIgnoreCase("Value looks invalid."));
    }
