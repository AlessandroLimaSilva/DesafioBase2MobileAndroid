Feature: revisar pedido
  ...
  Scenario: Não revisar o pedido sem informar o nome completo
    ...
    And em entrega tenha informado o nome completo Rebecca the Princess, rua Mandorley 112, cidade Truro, cep 89750 e pais United Kingdom
  ...
  Scenario: Não revisar o pedido sem informar o numero do cartao
    ...
    And que ele tenha adicionado um item ao carrinho
    And em entrega tenha informado o nome completo Rebecca the Princess, rua Mandorley 112, cidade Truro, cep 89750 e pais United Kingdom
    And em revisar pedido tenha informado o nome completo Rebecca the Princess, data de validade 0325, codigo de segurança 123 e não informou o numero do cartão
    When o usuario confirmar revisar o pedido
  ...
  Scenario: Não revisar o pedido sem informar a data de validade
    ...
    And que ele tenha adicionado um item ao carrinho
    And em entrega tenha informado o nome completo Rebecca the Princess, rua Mandorley 112, cidade Truro, cep 89750 e pais United Kingdom
    And em revisar pedido tenha informado o nome completo Rebecca the Princess, numero do cartão 325812657568789, codigo de segurança 123 e não informou a data de validade
    When o usuario confirmar revisar o pedido
  ...
  Scenario: Não revisar o pedido sem informar o codigo de seguranca
    ...
    And que ele tenha adicionado um item ao carrinho
    And em entrega tenha informado o nome completo Rebecca the Princess, rua Mandorley 112, cidade Truro, cep 89750 e pais United Kingdom
    And em revisar pedido tenha informado o nome completo Rebecca the Princess, numero do cartão 325812657568789, data de validade 0325 e não informou o codigo de seguranca
    When o usuario confirmar revisar o pedido
  ...
  Scenario: Não revisar o pedido sem informar o nome de quem recebera a compra quando o endereço de entrega é diferente do usuario
    ...
    And que ele tenha adicionado um item ao carrinho
    And em entrega tenha informado o nome completo Rebecca the Princess, rua Mandorley 112, cidade Truro, cep 89750 e pais United Kingdom
    And em pagamento tenha informado nome titular do cartão Rebecca the Princess, numero do cartão 325812657568789, data de validade 0325 e codigo de segurança 123
  ...
  Scenario: Não revisar o pedido sem informar o pais quando o endereço de entrega é diferente do usuario
    ...
    And em pagamento tenha informado nome titular do cartão Rebecca the Princess, numero do cartão 325812657568789, data de validade 0325 e codigo de segurança 123
    And ele não tenha selecionado meu endereço de cobrança é igual ao meu endereço de entrega
    And o usuario informou o nome completo Rebecca the Princess, rua Mandorley 112, cidade Truro, cep 89750 e não informa o pais
    When o usuario confirmar revisar o pedido
